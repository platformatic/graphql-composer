...
class QueryBuilder {
  ...
  buildSelectionSet (ctx, node, schemaNode) {
    ...
    const selectedFields = this.buildSelectionFields(bareType, keyFields, selectionFields)
  ...
  buildSelectionFields (type, keyFields, selectionFields) {
    ...
    for (const s of selectionFields.values()) {
      selectionKeyFields.add(s)
    }
