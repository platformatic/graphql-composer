...
class Composer {
   ...
   *
   * Without this pass the field silently kept the last subgraph's resolver while a shared enum
   * kept the first subgraph's values, so a call could validate against one subgraph and run
   * against another.
   */
